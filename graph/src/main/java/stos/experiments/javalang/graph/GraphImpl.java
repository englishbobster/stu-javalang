...
class GraphImpl<V, E extends CostableEdge> implements Graph<V, E>{

    private Set<Vertex<V>> vertices;
    private Set<Edge<V, E>> edges;

    GraphImpl(Set<Vertex<V>> vertices, Set<Edge<V, E>> edges) {
    ...
    @Override
    public List<Route<V, E>> getRoutes(Vertex<V> a, Vertex<V> z) {
     ...
     */
    @Override
    public Route<V, E> findCheapestRoute(Vertex<V> a, Vertex<V> z) {
